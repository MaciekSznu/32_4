...
// describe pozwala grupowac testy, pierwszy argument - nazwa test suite czyli grupy testów, drugi to callback - funkcja zawireająca testy lub test suites, które można zagnieżdżać
describe('formatDate', () => {
  describe('seconds', () => {
    // poniżej test zaczynający sie od it
